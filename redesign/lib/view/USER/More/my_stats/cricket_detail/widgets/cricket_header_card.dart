...
class CricketHeaderCard extends StatelessWidget {
  final SportStatModel stat;

  const CricketHeaderCard({super.key, required this.stat});
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.sports_cricket, color: AppColors.accent, size: 28),
          ),
