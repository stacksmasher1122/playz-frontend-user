...
class BadmintonHeaderCard extends StatelessWidget {
  final SportStatModel stat;

  const BadmintonHeaderCard({super.key, required this.stat});
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.sports, color: AppColors.accent, size: 28),
          ),
