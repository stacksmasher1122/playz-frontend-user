...
import 'package:redesign/view/USER/Home/Scoreboard/Karate/live_match/widgets/karate_score_display.dart';
import 'package:redesign/view/USER/Home/Scoreboard/Karate/live_match/widgets/karate_action_buttons.dart';
import 'package:redesign/view/USER/Home/scoreboard_screen/scoreboards_screen.dart';

class KarateScoreboardScreen extends StatefulWidget {
  const KarateScoreboardScreen({super.key});

  @override
  State<KarateScoreboardScreen> createState() => _KarateScoreboardScreenState();
}

class _KarateScoreboardScreenState extends State<KarateScoreboardScreen> {
  ...
  void _showMatchFinishedDialog(BuildContext context, KarateController controller) {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: const KarateActionButtons(),
      ),
    );
  }
  ...
  void _showExitConfirmationDialog(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: AppColors.cardSurface,
        title: const Text('Exit Kumite?', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        content: const Text(
