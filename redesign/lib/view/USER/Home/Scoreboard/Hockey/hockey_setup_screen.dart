...
import 'package:redesign/view/USER/Home/Scoreboard/Hockey/widgets/hockey_team_card.dart';
...
class HockeySetupScreen extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              Text(
                'Configure pitch squad, periods, battle rosters and FIH rules.',
              ...
              // 5. Match Quarters/Periods Large Stepper Card
              _buildLargeStepperCard(
                context,
                title: 'MATCH FORMAT',
                mainText: 'Periods (2 Halves or 4 Quarters)',
                valueStream: controller.maxPeriods,
                onDecrement: () {
                  if (controller.maxPeriods.value > 2) {
                    controller.setMaxPeriods(controller.maxPeriods.value - 2);
                  }
                },
                onIncrement: () {
                  if (controller.maxPeriods.value < 4) {
                    controller.setMaxPeriods(controller.maxPeriods.value + 2);
                  }
                },
              ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 2),
                Text(
                  'Enforces 4 x 15m Quarters, 11v11, Green/Yellow card suspensions.',
                  style: AppTypography.bodySm.copyWith(
                    color: AppColors.mutedText,
                    fontSize: ResponsiveHelper.sp(12),
                  ).responsive(context),
  ...
  Widget _buildStartMatchButton(BuildContext context, HockeyController controller) {
    return Container(
      padding: EdgeInsets.all(ResponsiveHelper.w(20)),
  ...
  void _openFriendsBottomSheet(BuildContext context, HockeyController controller, {required bool isTeamA}) {
