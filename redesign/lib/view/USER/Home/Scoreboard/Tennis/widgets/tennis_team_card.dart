...
import 'tennis_friends_selection_sheet.dart';

class TennisTeamCard extends StatelessWidget {
  final BuildContext context;
  final TennisController controller;
  final String title;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Optional editable Team / Player Name Input
          ...
          // Search & Add Players Button (exact Badminton style)
          GestureDetector(
          ...
          // Render selected player chips (exact Badminton style)
          Obx(() {
  ...
  void _showFriendsBottomSheet(BuildContext context, bool isSideA) {
    showModalBottomSheet(
      ...
      builder: (context) {
        return TennisFriendsSelectionSheet(
