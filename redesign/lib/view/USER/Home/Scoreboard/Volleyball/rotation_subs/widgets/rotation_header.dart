  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Container(width: ResponsiveHelper.w(4), height: ResponsiveHelper.h(24), color: AppColors.accent),
            SizedBox(width: 8),
            Text('TEAM A • SERVING', style: AppTypography.labelCaps10.copyWith(color: AppColors.accent, fontWeight: FontWeight.bold, letterSpacing: 1.5)),
          ],
        ),
        SizedBox(height: 4),
        ...
        Align(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(controller.receivingTeam.toUpperCase(), style: AppTypography.headlineSm.copyWith(color: AppColors.accent, fontWeight: FontWeight.w900)),
            ],
          ),
        ),
        SizedBox(height: 8),
