...
class LiveMatchesScreenBasketball extends StatelessWidget {
  const LiveMatchesScreenBasketball({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: AppColors.background,
        title: const Text('Live Basketball Matches', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
        centerTitle: true,
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () async {
                  ...
                  Get.toNamed('/basketball_scoreboard'); // Assuming router config, or Push directly
                },
                child: Container(
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Text('LIVE', style: TextStyle(color: AppColors.accent, fontSize: 12, fontWeight: FontWeight.w700)),
                            ),
                            Text(
