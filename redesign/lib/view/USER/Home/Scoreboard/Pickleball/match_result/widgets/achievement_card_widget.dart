...
class _AchievementCardWidgetState extends State<AchievementCardWidget>
  ...
  void initState() {
    ...
    _animController = AnimationController(
      vsync: this,
      duration: Duration(milliseconds: 300 + (widget.achievements.length * 80)),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          ...List.generate(widget.achievements.length, (index) {
            double start =
                (index * 80) / (300 + (widget.achievements.length * 80));
            double end =
                start + (300 / (300 + (widget.achievements.length * 80)));
            if (end > 1.0) end = 1.0;
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          widget.achievements[index].substring(
                            3,
                          ), // Assuming "emoji space text"
