...
import 'package:redesign/view/USER/Home/Scoreboard/Judo/live_match/widgets/judo_score_display.dart';
import 'package:redesign/view/USER/Home/Scoreboard/Judo/live_match/widgets/judo_action_buttons.dart';
import 'package:redesign/view/USER/Home/scoreboard_screen/scoreboards_screen.dart';

class JudoScoreboardScreen extends StatefulWidget {
  const JudoScoreboardScreen({super.key});

  @override
  State<JudoScoreboardScreen> createState() => _JudoScoreboardScreenState();
}

class _JudoScoreboardScreenState extends State<JudoScoreboardScreen> {
  ...
  void _showMatchFinishedDialog(BuildContext context, JudoController controller) {
      ...
      builder: (ctx) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            final matchResult = controller.currentMatch.value?.matchResult ?? 'Contest Finished';
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: const JudoActionButtons(),
      ),
    );
  }
  ...
  void _showExitConfirmationDialog(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: AppColors.cardSurface,
        title: const Text('Exit Contest?', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        content: const Text(
