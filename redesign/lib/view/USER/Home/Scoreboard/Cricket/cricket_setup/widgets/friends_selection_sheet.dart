            ...
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final bool inHome = controller.homeTeamPlayers.contains(friend.email);
                  final bool inAway = controller.awayTeamPlayers.contains(friend.email);
...
class BadmintonFriendsSelectionSheet extends StatelessWidget {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Obx(
                () => Text(
                  '( ${isSideA ? controller.teamARoster.length : controller.teamBRoster.length} / ${controller.maxAllowedPlayers.value} )',
                  style: TextStyle(color: AppColors.muted, fontSize: 14),
                ),
              ),
            ],
          ...
          Expanded(
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final friend = allSelectable[index];
                  final bool inA = controller.teamAPlayers.contains(friend.email);
                  final bool inB = controller.teamBPlayers.contains(friend.email);
...
class SquashFriendsSelectionSheet extends StatelessWidget {
  final SquashController controller;
  final bool isSideA;

  const SquashFriendsSelectionSheet({
    super.key,
    required this.controller,
    required this.isSideA,
  });
...
class KabaddiFriendsSelectionSheet extends StatelessWidget {
  final KabaddiController controller;
  final bool isSideA;

  const KabaddiFriendsSelectionSheet({
    super.key,
    required this.controller,
    required this.isSideA,
  });
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Obx(
                () => Text(
                  '( ${isSideA ? controller.teamARoster.length : controller.teamBRoster.length} / ${controller.maxAllowedPlayers} )',
                  style: TextStyle(color: AppColors.muted, fontSize: 14),
                ),
              ),
            ],
          ...
          Expanded(
            child: Obx(() {
              ...
              final currentUserName = FirebaseAuth.instance.currentUser?.displayName ?? 'You';

              List<FriendModel> allSelectable = [];
              if (currentUserEmail != null) {
                allSelectable.add(FriendModel(email: currentUserEmail, fullName: '$currentUserName (You)'));
              }
              allSelectable.addAll(friendsCtrl.friends);
