...
class _PreviousMatchesScreenState extends State<PreviousMatchesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: kBg,
        title: const Text('Previous Matches', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
        centerTitle: true,
      ...
      body: FutureBuilder<List<CricketMatchModel>>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.isEmpty) {
            return const Center(child: Text("No previous matches found.", style: TextStyle(color: kMuted)));
          }
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              const Text('vs', style: TextStyle(color: kMuted, fontSize: 12)),
              Text(
                match.awayTeamName,
                style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold),
              ),
